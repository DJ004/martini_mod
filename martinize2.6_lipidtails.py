...
'Updated with lipid tail parameters according to DOI:10.1021/acs.jpcb.7b10175 - Dheeraj Prakaash (DJ) - 2nd Oct 2019'
...
class martini22:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            ...
            "ARG": [spl("N0 Qd"),            [(0.330,5000), (0.340,5000)],                           [(180,25)]],
            "LYS": [spl("C3 Qd"),            [(0.330,5000), (0.280,5000)],                           [(180,25)]],
            "CYS": [spl("C5"),               [(0.310,7500)]],									# ANGLES (No dihedrals for lipid tails)
...
AA3     = spl("TRP TYR PHE HIS HIH ARG LYS CYS CYF CYG CYP GMN ASP GLU ILE LEU MET ASN PRO HYP GLN SER THR VAL ALA GLY"+dnares3+rnares3) #@# # DJ
AA1     = spl("  W   Y   F   H   H   R   K   C   B   J   U   Z   D   E   I   L   M   N   P   O   Q   S   T   V   A   G"+dnares1+rnares1) #@# # DJ
